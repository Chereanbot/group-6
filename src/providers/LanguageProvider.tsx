...
const translations = {
  am: {
    ...
    'payment.plans.select': 'እቅድ ይምረጡ',
    'payment.currency': 'ብር',
    'payment.confirm.title': 'ክፍያ ያረጋግጡ',
    'payment.confirm.description': 'ክፍያዎን ከመቀጠልዎ በፊት የደንበኝነት ዝርዝሮችዎን ይገምግሙ',
    'payment.confirm.details': 'የደንበኝነት ዝርዝሮች',
    'payment.confirm.plan': 'እቅድ',
    'payment.confirm.price': 'ዋጋ',
    'payment.confirm.initialPayment': 'የመጀመሪያ ክፍያ',
    'payment.methods.title': 'የክፍያ ዘዴ',
    'payment.methods.chapa': 'ቻፓ',
    'payment.methods.chapaDescription': 'ከካርድዎ ወይም ከሞባይል ገንዘብ ጋር በደህንነት ይክፈሉ',
    'payment.methods.mpesa': 'ኤም-ፔሳ',
    'payment.methods.mpesaDescription': 'ከኤም-ፔሳ ጋር ይክፈሉ',
    'payment.methods.mpesaPhone': 'የኤም-ፔሳ ስልክ ቁጥር',
    'payment.methods.mpesaPhonePlaceholder': 'ለምሳሌ፣ 254712345678',
    'payment.methods.mpesaPhoneHelp': 'የተመዘገቡትን የኤም-ፔሳ ስልክ ቁጥርዎን ያስገቡ',
    'payment.actions.back': 'ተመለስ',
    'payment.actions.processing': 'በማስኬድ ላይ...',
    'payment.actions.proceed': 'ወደ ክፍያ ይቀጥሉ',
    'payment.loading.title': 'ክፍያ በመጀመር ላይ',
    'payment.loading.description': 'ወደ የደህንነታችን የክፍያ መግቢያ እስኪያዘዝዙዎ ይጠብቁ',
    'payment.verification.title': 'ክፍያ በማረጋገጥ ላይ',
    'payment.verification.description': 'ክፍያዎን እያረጋገጥን እንደሆነ ይጠብቁ...',
    'payment.success.title': 'ክፍያ በመጠበቅ ላይ - በቅርቡ እናሳውቃለን!',
    'payment.success.description': 'ክፍያዎ በመጠበቅ ላይ ተካሂዷል። የአገልግሎት ጥያቄዎን እያዘጋጅን ነው።',
    'payment.success.flow.title': 'የክፍያ ሂደት',
    'payment.success.steps.clientPayment.title': 'የደንበኛ ክፍያ',
    'payment.success.steps.clientPayment.description': 'ክፍያ ከመለያዎ ተጀምሯል',
    'payment.success.steps.bankProcessing.title': 'የባንክ ሂደት',
    'payment.success.steps.bankProcessing.description': 'ክፍያ በባንኩ በማስኬድ ላይ',
    'payment.success.steps.lawyerAssignment.title': 'የጠበቃ ምደባ',
    'payment.success.steps.lawyerAssignment.description': 'ክፍያ ወደ የጠበቃ መለያ ተዛውሯል',
    'payment.success.nextSteps.title': 'ቀጣይ እርምጃዎች',
    'payment.success.nextSteps.description': 'ክፍያዎ እንደተረጋገጠ እና የአገልግሎት ጥያቄዎ እንደተካሄደ እናሳውቃለን።',
    'payment.success.nextSteps.step1': 'የክፍያ ዝርዝሮችዎን የያዘ የማረጋገጫ ኢሜይል ይቀበላሉ',
    'payment.success.nextSteps.step2': 'ቡድናችን የአገልግሎት ጥያቄዎን ይገመግማል',
    'payment.success.nextSteps.step3': 'ጠበቃ ለጉዳይዎ ይመደባል',
  },
  en: {
    // Navigation
    ...
    'payment.plans.basic.title': 'Basic',
    'payment.plans.basic.description': 'For individuals',
    'payment.plans.basic.price': '2,000 ETB',
    'payment.plans.basic.duration': '/month',
    'payment.plans.basic.features.1': 'Basic legal consultation',
    'payment.plans.basic.features.2': 'Document review',
    'payment.plans.basic.features.3': '2 appointments per month',
    'payment.plans.basic.features.4': 'Email support',
    'payment.plans.pro.title': 'Professional',
    'payment.plans.pro.description': 'For individuals and small businesses',
    'payment.plans.pro.price': '5,000 ETB',
    'payment.plans.pro.duration': '/month',
    'payment.plans.pro.features.1': 'All basic features',
    'payment.plans.pro.features.2': 'Priority case handling',
    'payment.plans.pro.features.3': 'Unlimited appointments',
    'payment.plans.pro.features.4': '24/7 phone support',
    'payment.plans.premium.title': 'Premium',
    'payment.plans.premium.description': 'For organizations',
    'payment.plans.premium.price': '10,000 ETB',
    'payment.plans.premium.duration': '/month',
    'payment.plans.premium.features.1': 'All professional features',
    'payment.plans.premium.features.2': 'Dedicated lawyer',
    'payment.plans.premium.features.3': 'Priority case handling',
    'payment.plans.premium.features.4': 'Premium support',
    'payment.plans.recommended': 'Recommended',
    'payment.plans.select': 'Select Plan',
    ...
    'payment.confirm.details': 'Subscription Details',
    'payment.confirm.plan': 'Plan',
    'payment.confirm.price': 'Price',
    'payment.confirm.initialPayment': 'Initial Payment',
    'payment.methods.title': 'Payment Method',
    'payment.methods.chapa': 'Chapa',
    'payment.methods.chapaDescription': 'Pay securely with your card or mobile money',
    'payment.methods.mpesa': 'M-Pesa',
    'payment.methods.mpesaDescription': 'Pay with M-Pesa',
    'payment.methods.mpesaPhone': 'M-Pesa Phone Number',
    'payment.methods.mpesaPhonePlaceholder': 'e.g., 254712345678',
    'payment.methods.mpesaPhoneHelp': 'Enter your M-Pesa registered phone number',
    'payment.actions.back': 'Back',
    'payment.actions.processing': 'Processing...',
    'payment.actions.proceed': 'Proceed to Payment',
    'payment.loading.title': 'Initializing Payment',
    'payment.loading.description': 'Please wait while we redirect you to our secure payment gateway',
    'payment.verification.title': 'Verifying Payment',
    'payment.verification.description': 'Please wait while we verify your payment...',
    'payment.success.title': 'Payment Pending - We will notify you soon!',
    'payment.success.description': 'Your payment has been processed PENDING. We\'re now preparing your service request.',
    'payment.success.flow.title': 'Payment Processing Flow',
    'payment.success.steps.clientPayment.title': 'Client Payment',
    'payment.success.steps.clientPayment.description': 'Payment initiated from your account',
    'payment.success.steps.bankProcessing.title': 'Bank Processing',
    'payment.success.steps.bankProcessing.description': 'Payment being processed by the bank',
    'payment.success.steps.lawyerAssignment.title': 'Lawyer Assignment',
    'payment.success.steps.lawyerAssignment.description': 'Payment transferred to lawyer account',
    'payment.success.nextSteps.title': 'Next Steps',
    'payment.success.nextSteps.description': 'We will notify you once your payment is confirmed and your service request is processed.',
    'payment.success.nextSteps.step1': 'You will receive a confirmation email with your payment details',
    'payment.success.nextSteps.step2': 'Our team will review your service request',
    'payment.success.nextSteps.step3': 'A lawyer will be assigned to your case',
  }
};
