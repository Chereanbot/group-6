  ...
  const steps = [
    {
      ...
      title: t('payment.success.steps.clientPayment.title', 'Client Payment'),
      description: t('payment.success.steps.clientPayment.description', 'Payment initiated from your account'),
      image: '/images/payment/client-payment.png',
    },
    {
      icon: <Building2 className="w-6 h-6" />,
      title: t('payment.success.steps.bankProcessing.title', 'Bank Processing'),
      description: t('payment.success.steps.bankProcessing.description', 'Payment being processed by the bank'),
      image: '/images/payment/bank-processing.png',
    },
    {
      icon: <Briefcase className="w-6 h-6" />,
      title: t('payment.success.steps.lawyerAssignment.title', 'Lawyer Assignment'),
      description: t('payment.success.steps.lawyerAssignment.description', 'Payment transferred to lawyer account'),
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">
            {t('payment.success.title', 'Payment Pending - We will notify you soon!')}
          </h1>
          <p className="text-lg text-gray-600 dark:text-gray-300">
            {t('payment.success.description', 'Your payment has been processed PENDING. We\'re now preparing your service request.')}
          </p>
        </motion.div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 mb-8">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">
            {t('payment.success.flow.title', 'Payment Processing Flow')}
          </h2>
        ...
        >
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">
            {t('payment.success.nextSteps.title', 'Next Steps')}
          </h2>
          <div className="space-y-4">
            {[
              {
